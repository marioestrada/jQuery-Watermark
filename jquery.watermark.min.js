 ...
 *
 */
(function(a){var k=a.browser.msie&&a.browser.version<8;a.watermarker=function(){};a.extend(a.watermarker,{defaults:{color:"#999",left:0,top:0,fallback:false,animDuration:300,minOpacity:0.6},setDefaults:function(e){a.extend(a.watermarker.defaults,e)},checkVal:function(e,c){e.length==0?a(c).show():a(c).hide();return e.length>0},html5_support:function(){return"placeholder"in document.createElement("input")}});a.fn.watermark=function(e,c){var i;c=a.extend(a.watermarker.defaults,c);i=this.filter("input[type=text], input[type=password], input[type=email], input[type=url], input[type=search], textarea");
...
parseInt(b.css("margin-top")):0;f=b.css("margin-left")!="auto"?parseInt(b.css("margin-left")):0;f+=b.css("padding-left")!="auto"?parseInt(b.css("padding-left")):0;d.css({position:"absolute",display:"block",fontFamily:b.css("font-family"),fontSize:b.css("font-size"),color:c.color,left:4+c.left+f,top:c.top+h,height:e_height,lineHeight:e_height+"px",textAlign:"left"}).data("jq_watermark_element",b);a.watermarker.checkVal(b.val(),d);d.click(function(){a(a(this).data("jq_watermark_element")).focus()});
b.before(d).focus(function(){a.watermarker.checkVal(a(this).val(),d)||d.stop().fadeTo(c.animDuration,c.minOpacity)}).bind("blur change",function(){a.watermarker.checkVal(a(this).val(),d)||d.stop().fadeTo(c.animDuration,1)}).keydown(function(){a(d).hide()}).keyup(function(){a.watermarker.checkVal(a(this).val(),d)})}});return this}};a(document).ready(function(){a(".jq_watermark").watermark()})})(jQuery);